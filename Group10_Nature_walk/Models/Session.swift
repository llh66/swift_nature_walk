...
// Initializer to set up a session 
    init(name: String, description: String, starRating: Int, host: String, photos: [String], pricePerPerson: Double) {
        self.name = name
